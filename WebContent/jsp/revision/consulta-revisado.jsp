...
<html:form action="/consulta-revisado.do" styleId="consultaRevisadoForm">
    <html:hidden property="method" value="" />
    <html:hidden name="consultaRevisadoForm" property="id_asunto" />
    <html:hidden name="consultaRevisadoForm" property="idx" />
    <html:hidden name="consultaRevisadoForm" styleId="nuevaconsulta" property="nuevaConsulta"/>
                    ...
                    <div class="accordion ui-accordion accordion-inner">
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.folio"
                                                   maxlength="50" size="15" styleClass="criterio upperCase"/>
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.id_asunto_ref"
                                                   maxlength="50" size="15" styleClass="criterio upperCase"/>
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.asunto"
                                                   maxlength="200" size="50" styleClass="criterio upperCase"/>
                                    </td>
                                    <td>
                                        <html:select property="criterioAsunto.id_tipo_documento" name="consultaRevisadoForm" styleClass="criterio">
                                            <html:option value="-1">Seleccione una opci&oacute;n</html:option>
                                            <html:optionsCollection name="consultaRevisadoForm"  property="tiposDocumento" value="id_tipo_documento" label="tipo_documento" />
                                        </html:select>
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.no_oficio"
                        ...
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <html:select property="criterioAsunto.id_prioridad" name="consultaRevisadoForm" styleClass="criterio">
                                            <html:option value="-1">Seleccione una opci&oacute;n</html:option>
                                            <html:optionsCollection name="consultaRevisadoForm"  property="prioridades" value="id_prioridad" label="prioridad" />
                                        </html:select>
                                    </td>
                                    <td colspan="2">
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.fh_limite_iniDDMMYYYY" styleId=""  styleClass="criterio calendario" />
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <html:select property="criterioAsunto.id_expediente" name="consultaRevisadoForm" styleClass="criterio">
                                            <html:option value="-1">Seleccione una opci&oacute;n</html:option>
                                            <html:optionsCollection name="consultaRevisadoForm" property="expedientes" value="id_expediente" label="expediente" />
                                        </html:select>
                                    </td>

                                    <td colspan="2">
                                        <html:select property="criterioAsunto.id_tema" name="consultaRevisadoForm" styleClass="criterio">
                                            <html:option value="-1">Seleccione una opci&oacute;n</html:option>
                                            <html:optionsCollection name="consultaRevisadoForm"  property="temas" value="id_tema" label="tema" />
                                        </html:select>
                        ...
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="3">
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.descripcion"
                        ...
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.fh_oficio_iniDDMMYYYY"
                                                   styleId="fh_oficio_ini" readonly="true" size="8" styleClass="criterio"/>
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.fh_oficio_finDDMMYYYY"
                                                   styleId="fh_oficio_fin" readonly="true" size="8" styleClass="criterio" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.fh_registro_iniDDMMYYYY"
                                                   styleId="fh_registro_ini" readonly="true" size="8" styleClass="criterio" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.fh_registro_finDDMMYYYY"
                    ...
                    <div class="accordion ui-accordion accordion-inner">
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td>
						Todo:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_remi"
                                                    styleClass="radio-arbol-todo" title="ramaA" alt="modal-arbol-todo"  value ="0" />
                                                Interno:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_remi"
                                                    styleClass="radio-arbol-interno" title="ramaA" alt="modal" value ="1" />
                               			Externo:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_remi"
                                                    styleClass="radio-arbol-externo" title="ramaA" alt="modal-arbol-externo"  value ="2" />
                                        <div id="ramaA" title="modal-rama">
                                            <html:text name="consultaRevisadoForm" property="criterioAsunto.area_remi"
                                                       disabled="true" styleClass="tree criterio" />
                                            <html:hidden name="consultaRevisadoForm" property="criterioAsunto.id_area_remi"
                                                         styleClass="id criterio" />
                                        </div>
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.nombre_remi"
                                                   maxlength="150" styleClass="criterio upperCase" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.paterno_remi"
                                                   maxlength="100" styleClass="criterio upperCase" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.materno_remi"
                                                   maxlength="100" styleClass="criterio upperCase" />
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="accordion ui-accordion accordion-inner">
                        <table class="criterio-consulta ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <tr>
                                    <td>
						 Todo:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_dest"
                                                    styleClass="radio-arbol-todo" title="arbolA" alt="modal-todo" value ="0" />
                                                 Interno:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_dest"
                                                    styleClass="radio-arbol-interno" title="arbolA" alt="modal" value ="1" />
                               			 Externo:<html:radio name="consultaRevisadoForm" property="criterioAsunto.tipo_area_dest"
                                                    styleClass="radio-arbol-externo" title="arbolA" alt="modal-arbol-externo"  value ="2" />
                                        <div id="arbolA">
                                            <html:text name="consultaRevisadoForm" property="criterioAsunto.area_dest"
                                                       disabled="true" styleClass="tree criterio" />
                                            <html:hidden name="consultaRevisadoForm" property="criterioAsunto.id_area_dest"
                                                         styleClass="id criterio" />
                                        </div>
                                    </td>

                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.nombre_dest"
                                                   maxlength="150" styleClass="criterio upperCase" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.paterno_dest"
                                                   maxlength="100" styleClass="criterio upperCase" />
                                    </td>
                                    <td>
                                        <html:text name="consultaRevisadoForm" property="criterioAsunto.materno_dest"
                                                   maxlength="100" styleClass="criterio upperCase" />
                                    </td>
                                </tr>
                            </tbody>
    ...
    <logic:notEmpty name="consultaRevisadoForm" property="asuntos">
        <div class="content border">
            <div class="inner corner">
                <div class="contentform accordion ui-accordion">
                    <table>
                        <thead>
                            <tr class="ui-widget-header">                          
                                <th colspan="11">Total:  <bean:write name="consultaRevisadoForm"  property="criterioAsunto.paginador.numRegistros" />  </th>
                            </tr>
                        </thead>                        

                        <tr>
                            <td>                           
                                <dt:table id="asunto" name="sessionScope.consultaRevisadoForm.asuntos"
                                          requestURI="/consulta-revisado.do?method=inicio&order=true" requestURIcontext="true"
                                ...
                                <html:hidden name="consultaRevisadoForm" styleId="pagina" property="criterioAsunto.paginador.pagina"/>
                                <html:hidden name="consultaRevisadoForm" styleId="paginas" property="criterioAsunto.paginador.paginas"/>
                                <div id="paginador">
                                </div>                            
                            </td>
                        </tr>
