...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Por favor introduzca una direcci&oacute;n email v&aacute;lida.",
		...
		creditcard: "Por favor introduzca un numero de tarjeta de credito valido.",
		equalTo: "Por favor introduzca el mismo valor nuevamente.",
		accept: "Por favor introduzca un valor con una extension valida.",
		maxlength: $.validator.format("Por favor introduzca no mas de {0} caracteres."),
		...
		rfc: "Por favor introduzca un RFC valido."
	},
	...
	methods: {
		...
		// Validacion del RFC en México
		rfc: function(value, element) {
			return this.optional(element) || /^[a-zA-Z]{4,4}[0-9]{6,6}[a-zA-Z0-9]*$/.test(value);
		},
